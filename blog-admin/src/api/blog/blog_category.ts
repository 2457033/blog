...
export const getBlogCategory = () => {
  return request.get<blogCategoryF[]>('/api/blog_category')
}

/** 增加分类 */
export const postBlogCategoryAdd = (category: string) => {
  return request.post('/api/blog_category/add', { category })
}

/** 修改分类 */
export const postBlogCategoryEdit = (data: categoryEditD) => {
  return request.post('/api/blog_category/edit', data)
}

/** 修改排序 */
export const postBlogCategorySort = (data: CategorySortF) => {
  return request.post('/api/blog_category/sort', data)
}

/** 删除 */
export const getBlogCategoryDel = (id: string) => {
  return request.get('/api/blog_category/delete', { id })
}

/** 获取分类 */
export const getCategory = () => {
  return request.get('/api/blog_category/category')
}
